...
$sql = "SELECT reg_num FROM stud_detail WHERE reg_num =" . "'" . $username . "' ";
	...
	if ($correct == $pass) {
		...
		if ($row[0] == 0) {
			...
			echo '<script type="text/JavaScript"> 
				alert("Welcome");
				window.open("./Student/index.php",\'TheNewpop\',\'toolbar=1,location=1,directories=1,status=1,menubar=1,scrollbars=1,resizable=1\');
				self.close()				
			  </script>';
		} else {
